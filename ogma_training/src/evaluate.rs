use ogma_symbolic::token::detokenize;
use ogma_symbolic::training_data::{parse_token_string, synthetic_debruijn};
use ogma_symbolic::validate::ValidationResult;

/// Reconstruct an Expr from input token strings.
pub fn tokens_to_expr(input_tokens: &[String]) -> Result<ogma_symbolic::Expr, String> {
...
mod tests {
    ...
    fn test_compute_reward_improved() {
        let result = ValidationResult {
            valid_steps: 2,
            total_steps: 2,
            final_expr: ogma_symbolic::Expr::new(ogma_symbolic::ExprKind::Rational(
                ogma_symbolic::rational::Rational::from_i64(1),
            )),
            final_complexity: 1,
            input_complexity: 5,
    ...
    fn test_compute_reward_empty() {
        let result = ValidationResult {
            ...
            total_steps: 0,
            final_expr: ogma_symbolic::Expr::new(ogma_symbolic::ExprKind::Rational(
                ogma_symbolic::rational::Rational::ZERO,
            )),
            final_complexity: 5,
            input_complexity: 5,
            step_details: Vec::new(),
    ...
    fn test_compute_metrics() {
        let results = vec![
            ...
            ValidationResult {
                ...
                total_steps: 1,
                final_expr: ogma_symbolic::Expr::new(ogma_symbolic::ExprKind::Rational(
                    ogma_symbolic::rational::Rational::from_i64(3),
                )),
                final_complexity: 3,
                input_complexity: 3,
                step_details: Vec::new(),
