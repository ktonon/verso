//! Public API for the document-facing parts of Ogma.
//!
//! The root exports are the intended high-level entry points for callers:
//!
//! - parse `.ogma` source into an AST
...
pub use config::{
    ...
    strip_jsonc_comments, ConfigError, PaperConfig, ResolvedConfig, ResolvedPaper, TestConfig,
    VersoConfig, CONFIG_FILENAME, CONFIG_FILENAMES, SCHEMA_CONTENT, SCHEMA_FILENAME, SCHEMA_REF,
    VERSION,
};
